...
function loadActiveSymbols() {
  const wsS = new WebSocket("wss://ws.derivws.com/websockets/v3?app_id=342XpdizPwxbulHZiEm9u");
...
function fetchOncePrice(symbol, timeoutMs = 4000) {
  return new Promise((resolve) => {
    ...
    const sock = new WebSocket("wss://ws.derivws.com/websockets/v3?app_id=342XpdizPwxbulHZiEm9u");
